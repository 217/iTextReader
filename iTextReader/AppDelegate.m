...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[BookViewController alloc] initWithFilepath: @"SchoolBook.epub"];
//    self.viewController = [[Demo1ViewController alloc] init];
    self.window.rootViewController = self.viewController;
    [self.window makeKeyAndVisible];
    
    CHDraggableView *draggableView = [CHDraggableView draggableViewWithImage:[UIImage imageNamed:@"BookSetting.png"]];
//    draggableView.tag = 1;
...
#pragma mark CHDraggingCoordinator Delegate
...
{
    return [[BookSettingViewController alloc] init];
}
